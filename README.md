...
A Minecraft fabric mod that allows players to practice Mace PvP.
...
* `/macebot`
  * `bot`
    * `spawn`
      * Spawns the Player bot.
    * `play`
      * Resumes The Idle Bot.
    * `pause`
      * Stops the Bot.
    * `mace-kit`
      * `netherite [<boolean>]`
        * Gives a netherite Mace HT kit to bot with unbreakable Tag. To get a kit with mending and unbreaking enchantments add `false` argument in end of command.
      * `diamond [<boolean>]`
  ...
  * `player`
    * `mace-kit`
      * `netherite [<boolean>]`
        * Gives a netherite Mace HT kit to player with unbreakable Tag. To get a kit with mending and unbreaking enchantments add `false` argument in end of command.
      * `diamond [<boolean>]`
